...
const about = {
  ...
  info: [
    { fieldName: "Name", fieldValue: "Ali Hamza" },
    { fieldName: "Phone", fieldValue: "(+92) 311 7192869" },
    { fieldName: "Experience", fieldValue: "1+ Years" },
    { fieldName: "Email", fieldValue: "alihamzaafzal888@gmail.com" },
...
const skills = {
  ...
  skillList: [
    ...
    { icon: <SiPostgresql />, name: "pgsql database" },
    { icon: <SiNextdotjs />, name: "next.js" },
    { icon: <SiShopify />, name: "shopify app" },
